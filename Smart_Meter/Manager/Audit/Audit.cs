...
namespace Manager.Audit
{
    public class Audit : IDisposable
    {
        ...
        const string SourceName = "Manager.Audit.Audit";
        const string LogName = "SmartMeterAudit";
        ...
        static Audit()
        {
            try
            {
                ...
                Console.WriteLine("EventLog created successfully.");
            }
            catch (Exception e)
            {
                customLog = null;
                Console.WriteLine("Error while trying to create log handle. Error = {0}", e);
            }
        }
